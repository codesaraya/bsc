...
export const AboutPage: GlobalConfig = {
  ...
  fields: [
    ...
    // Equipment section
    { name: 'equipmentBadge', type: 'text', label: 'Oprema badge', defaultValue: 'Naša oprema', localized: true },
    { name: 'equipmentTitle', type: 'text', label: 'Oprema naslov', defaultValue: 'Mašine koje pokreću naš rad', localized: true },
    { name: 'equipmentSubtitle', type: 'textarea', label: 'Oprema podnaslov', defaultValue: 'Koristimo vodeće svjetske brendove u digitalnoj štampi, laserskom rezanju i CNC obradi kako bismo vam pružili vrhunski kvalitet.', localized: true },
    {
      name: 'equipmentItems',
      type: 'array',
      label: 'Oprema / Mašine',
      admin: { description: 'Lista mašina sa detaljnim opisima' },
      fields: [
        { name: 'name', type: 'text', required: true, localized: true, label: 'Naziv mašine' },
        { name: 'category', type: 'text', localized: true, label: 'Kategorija (npr. Lasersko rezanje)' },
        { name: 'description', type: 'textarea', required: true, localized: true, label: 'Detaljan opis' },
        { name: 'icon', type: 'select', label: 'Ikona', options: [
          { label: 'Printer', value: 'Printer' },
          { label: 'Zap', value: 'Zap' },
