      ...
      fields: [
        ...
        { name: 'starburstText', type: 'text', defaultValue: 'Kvalitetna Štampa', localized: true },
        {
          ...
          fields: [
            ...
            { name: 'uploadedImage', type: 'upload', relationTo: 'media', label: 'Slika' },
            { name: 'slug', type: 'text', label: 'Slug (URL identifier)', admin: { description: 'e.g. scc, budakovici, aria' } },
            { name: 'address', type: 'text', localized: true, label: 'Adresa' },
            ...
            { name: 'mapUrl', type: 'text', label: 'Google Maps URL' },
            {
              ...
              localized: true,
              fields: [
                { name: 'days', type: 'text', required: true, label: 'Dani (npr. Pon-Pet)' },
                { name: 'hours', type: 'text', required: true, label: 'Sati (npr. 08:00-17:00)' },
              ],
            },
          ],
        },
