  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'logoAlt', type: 'text', label: 'Alt tekst za logo u navigaciji', defaultValue: 'BSC - Best Solution Company', localized: true },
        { name: 'notFoundTitle', type: 'text', label: 'Naslov za 404 stranicu', defaultValue: 'Nije pronađeno', localized: true },
        { name: 'locationAddress', type: 'text', label: 'Lokacija: "Adresa" label', defaultValue: 'Adresa', localized: true },
        { name: 'locationPhone', type: 'text', label: 'Lokacija: "Telefon" label', defaultValue: 'Telefon', localized: true },
        { name: 'locationViber', type: 'text', label: 'Lokacija: "Viber" label', defaultValue: 'Viber', localized: true },
        { name: 'locationEmail', type: 'text', label: 'Lokacija: "Email" label', defaultValue: 'Email', localized: true },
        { name: 'locationWorkingHours', type: 'text', label: 'Lokacija: "Radno vrijeme" label', defaultValue: 'Radno vrijeme', localized: true },
        { name: 'locationGoogleMaps', type: 'text', label: 'Lokacija: "Google Maps" label', defaultValue: 'Google Maps', localized: true },
      ],
    },
  ],
}
