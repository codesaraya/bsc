...
async function seed() {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      hero: {
        badge: 'BSC Sarajevo',
        headingLine1: 'Štampa velikih formata',
        headingLine2: 'za velike ideje',
      ...
      aboutPreview: {
        ...
        featureCards: [
          { title: 'UV LED Tehnologija', description: 'UV LED mašina širine štampe 3,2m — jedina na ovim prostorima. Direktan print na krute i fleksibilne materijale vrhunskog kvaliteta.', icon: 'Cpu', color: 'text-primary bg-primary/10', border: 'border-primary/20' },
          { title: 'Print na sve materijale', description: 'Gong Zheng UV štampa na staklo, plexy, alubond, forex, MDF, drvo, Acyplac, Kapafix i još mnogo toga.', icon: 'Layers', color: 'text-amber-500 bg-amber-50', border: 'border-amber-200' },
        ],
      },
      servicesTicker: {
        services: [
      ...
      clientsSection: {
        badge: 'Naši klijenti i partneri',
        title: 'Saradnje na koje smo ponosni',
        subtitle: 'Predstavljamo naše trenutne i dosadašnje klijente i partnere — kompanije s kojima sarađujemo i s kojima smo imali zadovoljstvo sarađivati.',
        clients: [
          ...
          { name: 'Orbico Beauty', uploadedLogo: await m('/Clients/orbico.jpg') },
        ...
        locations: [
          {
            ...
            workingHours: [
              { days: 'Pon-Sub', hours: '10:00-22:00' },
            ],
          },
          {
            ...
            uploadedImage: await m('/BUDAKOVICI.jpg'),
            slug: 'budakovici',
  ...
  await payload.updateGlobal({
    ...
    data: injectIds(bsHomepage, {
      ...
      hero: {
        badge: 'BSC Sarajevo',
        headingLine1: 'Large format printing',
        headingLine2: 'for big ideas',
      ...
      aboutPreview: {
        ...
        featureCards: [
          { title: 'UV LED Technology', description: 'UV LED machine with 3.2m print width — the only one in the region. Direct printing on rigid and flexible materials in top quality.', icon: 'Cpu', color: 'text-primary bg-primary/10', border: 'border-primary/20' },
          { title: 'Print on all materials', description: 'Gong Zheng UV printing on glass, plexiglass, alubond, forex, MDF, wood, Acyplac, Kapafix and much more.', icon: 'Layers', color: 'text-amber-500 bg-amber-50', border: 'border-amber-200' },
        ],
      },
      servicesTicker: {
        services: [
      ...
      clientsSection: {
        ...
        title: 'Collaborations we\u2019re proud of',
        subtitle: 'Meet our current and former clients and partners \u2014 companies we work with and those we\'ve had the pleasure of collaborating with.',
        clients: [
          { name: 'Coca-Cola', uploadedLogo: await m('/Clients/cocacola.jpg') },
          { name: 'dm', uploadedLogo: await m('/Clients/dm.jpg') },
          { name: 'BH Telecom', uploadedLogo: await m('/Clients/bhtelecom.jpg') },
      ...
      statsSection: {
        ...
        locations: [
          {
            title: 'BSC Sarajevo City Center',
            text: 'Your destination for fast graphic services — flyers, brochures, UV prints, business cards, pens, lighters, mugs, textile printing, plexiglass stands, stamp making, copying, scanning, and graphic design.',
            uploadedImage: await m('/SCC.jpg'),
            slug: 'scc',
            address: 'Sarajevo City Center, Vrbanja 1, 71000 Sarajevo',
            phone: '+387 33 571 111',
            viber: '+387 61 200 100',
            email: 'bscsarajevo@gmail.com',
            mapUrl: 'https://maps.google.com/?q=Sarajevo+City+Center',
            workingHours: [
              { days: 'Mon-Sat', hours: '10:00-22:00' },
            ],
          },
          {
            title: 'BSC Budakovici',
            text: 'Production facility for large format printing — XXL formats, billboards, banners, vehicle branding, portals, wallpapers, neon signs, plexiglass stands, posters, and all types of outdoor and indoor solutions.',
            uploadedImage: await m('/BUDAKOVICI.jpg'),
            slug: 'budakovici',
            address: 'Budakovići bb, 71000 Sarajevo',
            phone: '+387 33 571 112',
          ...
          {
            title: 'BSC Aria Mall Sarajevo',
            text: 'Print Shop at Aria Mall — flyers, brochures, UV prints, business cards, pens, lighters, mugs, textile printing, plexiglass stands, stamp making, copying, scanning, and graphic design.',
            uploadedImage: await m('/BBI.jpg'),
            slug: 'aria',
            address: 'Aria Mall, Trg djece Sarajeva 1, 71000 Sarajevo',
            phone: '+387 33 571 113',
            ...
            mapUrl: 'https://maps.google.com/?q=Aria+Mall+Sarajevo',
            workingHours: [
              { days: 'Mon-Sat', hours: '09:00-22:00' },
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      uiLabels: {
        ...
        locationViber: 'Viber',
        locationEmail: 'Email',
        locationWorkingHours: 'Radno vrijeme',
        locationGoogleMaps: 'Google Maps',
      },
    },
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      uiLabels: {
        ...
        locationViber: 'Viber',
        locationEmail: 'Email',
        locationWorkingHours: 'Working hours',
        locationGoogleMaps: 'Google Maps',
      },
    },
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      locations: [
        { name: 'BSC Sarajevo City Centar', address: 'Vrbanja 1, 71000 Sarajevo', phone: '+387 33 571 111', email: 'bscsarajevo@gmail.com' },
        { name: 'BSC Budakovići', address: 'Budakovići bb, 71000 Sarajevo', phone: '+387 33 571 112', email: 'bscsarajevo@gmail.com' },
        { name: 'BSC Aria Mall Sarajevo', address: 'Trg djece Sarajeva 1, 71000 Sarajevo', phone: '+387 33 571 113', email: 'bscsarajevo@gmail.com' },
      ],
      copyrightText: 'BSC. Sva prava zadržana.',
      contactTitle: 'Naše lokacije',
      bottomLinks: [
  ...
  await payload.updateGlobal({
    ...
    data: injectIds(bsFooter, {
      ...
      locations: [
        { name: 'BSC Sarajevo City Center', address: 'Vrbanja 1, 71000 Sarajevo', phone: '+387 33 571 111', email: 'bscsarajevo@gmail.com' },
        { name: 'BSC Budakovici', address: 'Budakovici bb, 71000 Sarajevo', phone: '+387 33 571 112', email: 'bscsarajevo@gmail.com' },
        { name: 'BSC Aria Mall Sarajevo', address: 'Trg djece Sarajeva 1, 71000 Sarajevo', phone: '+387 33 571 113', email: 'bscsarajevo@gmail.com' },
      ],
      copyrightText: 'BSC. All rights reserved.',
      contactTitle: 'Our locations',
      bottomLinks: [
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      description1: 'Best Solution Company je specijalizirana štamparija opremljena najnovijim digitalnim UV mašinama, uključujući UV LED mašinu velikog formata sa širinom štampe od 3.2m — jedinu mašinu u ovoj regiji — kao i Gong Zheng UV koja štampa sve ravne materijale (staklo, pleksiglas, alubond, forex, MDF, drvo itd.)',
      ...
      equipmentBadge: 'Naša oprema',
      equipmentTitle: 'Mašine koje pokreću naš rad',
      equipmentSubtitle: 'Koristimo vodeće svjetske brendove u digitalnoj štampi, laserskom rezanju i CNC obradi kako bismo vam pružili vrhunski kvalitet.',
      equipmentItems: [
        { name: 'AEON Laser', category: 'Lasersko rezanje i graviranje', description: 'AEON Laser su industrijski CO2 laserski sistemi za precizno rezanje i graviranje širokog spektra materijala — akril, drvo, MDF, koža, staklo, papir, tekstil i mnogi drugi. Koristimo ih za izradu reklamnih panela, svetlećih reklama, pleksiglas stalaka, gravura, dekorativnih elemenata i personaliziranih proizvoda. Laserska preciznost omogućava složene oblike i fine detalje koje tradicionalne metode ne mogu postići.', icon: 'Zap' },
        { name: 'Gong Zheng UV', category: 'UV flatbed štampa', description: 'Gong Zheng UV flatbed printeri koriste najnoviju UV LED tehnologiju sa Ricoh Gen6 i Epson I3200 glavama za direktan print na ravne i krute materijale. Štampamo na staklu, pleksiglasu, alubondu, foreksu, MDF-u, drvetu, keramici i još mnogo toga. Naša mašina velikog formata sa širinom štampe od 3.2m jedina je takva u regiji, što nam daje apsolutnu prednost u kvalitetu i kapacitetu UV štampe.', icon: 'Printer' },
        { name: 'HP Latex', category: 'Latex štampa velikog formata', description: 'HP Latex printeri koriste vodenu latex tehnologiju tinte koja je ekološki prihvatljiva, bez mirisa i sigurna za unutrašnju upotrebu. Idealni su za postere, bannere, vehicle wrapping, tapete, POS materijale i dekorativne grafike. Otisci su odmah suhi, otporni na ogrebotine i UV zračenje, s živim bojama koje traju godinama — savršeni za unutrašnju i vanjsku primjenu.', icon: 'Sparkles' },
        { name: 'MUTOH', category: 'Eco-solvent štampa', description: 'MUTOH eco-solvent printeri (ValueJet serija) specijalizirani su za visokokvalitetnu štampu na vinil folijama, bannerima, ceradama, naljepnicama i raznim fleksibilnim materijalima. Eco-solvent tinte pružaju izuzetnu otpornost na vremenske uvjete, UV zračenje i vlagu, čineći ih idealnim za outdoor reklame, brendiranje vozila, izloge i dugotrajne grafičke aplikacije.', icon: 'Printer' },
        { name: 'SUMA CNC', category: 'CNC rezanje i plotanje', description: 'SUMA CNC mašine služe za precizno konturno rezanje vinila, folija, reflektirajućih materijala i tanjih fleksibilnih podloga. Koriste se za izradu naljepnica, oznaka, sigurnosnih traka, brendiranja vozila i dekorativnih grafika. Automatsko pozicioniranje i visoka preciznost osiguravaju čiste rezove čak i kod najsloženijih oblika i sitnih detalja.', icon: 'Scissors' },
        { name: 'Dizart CNC', category: 'CNC glodanje i rezanje', description: 'Dizart CNC mašine su industrijski CNC routeri za glodanje i rezanje krutih materijala — alubond, PVC, akril, drvo, MDF, forex i kompozitne ploče. Koristimo ih za izradu 3D slova, reklamnih totema, svjetlećih kutija, dekorativnih panela i složenih prostornih konstrukcija. Preciznost CNC obrade osigurava savršene rubove i ponavljivi kvalitet u serijskoj proizvodnji.', icon: 'Cpu' },
        { name: 'XEROX', category: 'Digitalna produkcijska štampa', description: 'XEROX digitalni produkcijski printeri omogućavaju brzu i kvalitetnu štampu na papirnim medijima — letci, brošure, katalozi, vizitke, plakati i razni promo materijali. Napredna tehnologija boja osigurava konzistentne, žive boje uz oštru reprodukciju teksta i slika. Idealni su za manje i srednje naklade gdje brzina i kvalitet moraju ići ruku pod ruku.', icon: 'Layers' },
        { name: 'CANON', category: 'Digitalna produkcijska štampa', description: 'CANON digitalni printeri dopunjuju naš produkcijski kapacitet i pružaju izuzetan kvalitet štampe za kataloge, knjige, časopise, poslovnu dokumentaciju i visokokvalitetne promo materijale. Njihova pouzdanost i precizna reprodukcija boja čine ih nezamjenjivim za projekte koji zahtijevaju najviše standarde kvaliteta u digitalnoj štampi manjih i srednjih formata.', icon: 'Star' },
      ],
    },
  })
  ...
  await payload.updateGlobal({
    ...
    data: injectIds(bsAboutPage, {
      ...
      description1: 'Best Solution Company is a specialized printing company equipped with the latest digital UV machines, including a large format UV LED machine with a print width of 3.2m — the only machine in this region — as well as Gong Zheng UV which prints on all flat materials (glass, plexiglass, alubond, forex, MDF, wood etc.)',
      ...
      equipmentBadge: 'Our Equipment',
      equipmentTitle: 'Machines that power our work',
      equipmentSubtitle: 'We use world-leading brands in digital printing, laser cutting and CNC machining to deliver you top-tier quality.',
      equipmentItems: [
        { name: 'AEON Laser', category: 'Laser cutting & engraving', description: 'AEON Laser are industrial CO2 laser systems for precise cutting and engraving of a wide range of materials — acrylic, wood, MDF, leather, glass, paper, textiles and many more. We use them to produce advertising panels, illuminated signs, plexiglass stands, engravings, decorative elements and personalized products. Laser precision enables complex shapes and fine details that traditional methods cannot achieve.', icon: 'Zap' },
        { name: 'Gong Zheng UV', category: 'UV flatbed printing', description: 'Gong Zheng UV flatbed printers use the latest UV LED technology with Ricoh Gen6 and Epson I3200 print heads for direct printing on flat and rigid materials. We print on glass, plexiglass, alubond, forex, MDF, wood, ceramics and much more. Our large format machine with a 3.2m print width is the only one of its kind in the region, giving us an absolute advantage in UV print quality and capacity.', icon: 'Printer' },
        { name: 'HP Latex', category: 'Large format latex printing', description: 'HP Latex printers use water-based latex ink technology that is environmentally friendly, odor-free and safe for indoor use. They are ideal for posters, banners, vehicle wrapping, wallpapers, POS materials and decorative graphics. Prints are instantly dry, scratch-resistant and UV-resistant, with vibrant colors that last for years — perfect for both indoor and outdoor applications.', icon: 'Sparkles' },
        { name: 'MUTOH', category: 'Eco-solvent printing', description: 'MUTOH eco-solvent printers (ValueJet series) are specialized for high-quality printing on vinyl films, banners, tarpaulins, stickers and various flexible materials. Eco-solvent inks provide exceptional resistance to weather conditions, UV radiation and moisture, making them ideal for outdoor advertising, vehicle branding, storefronts and long-lasting graphic applications.', icon: 'Printer' },
        { name: 'SUMA CNC', category: 'CNC cutting & plotting', description: 'SUMA CNC machines are used for precise contour cutting of vinyl, films, reflective materials and thinner flexible substrates. They are used to produce stickers, labels, safety strips, vehicle branding and decorative graphics. Automatic positioning and high precision ensure clean cuts even with the most complex shapes and fine details.', icon: 'Scissors' },
        { name: 'Dizart CNC', category: 'CNC milling & routing', description: 'Dizart CNC machines are industrial CNC routers for milling and cutting rigid materials — alubond, PVC, acrylic, wood, MDF, forex and composite panels. We use them to produce 3D letters, advertising totems, illuminated boxes, decorative panels and complex spatial constructions. CNC machining precision ensures perfect edges and repeatable quality in serial production.', icon: 'Cpu' },
        { name: 'XEROX', category: 'Digital production printing', description: 'XEROX digital production printers enable fast, high-quality printing on paper media — flyers, brochures, catalogs, business cards, posters and various promotional materials. Advanced color technology ensures consistent, vivid colors with sharp text and image reproduction. They are ideal for small to medium print runs where speed and quality must go hand in hand.', icon: 'Layers' },
        { name: 'CANON', category: 'Digital production printing', description: 'CANON digital printers complement our production capacity and deliver exceptional print quality for catalogs, books, magazines, business documents and high-quality promotional materials. Their reliability and precise color reproduction make them indispensable for projects demanding the highest quality standards in small to medium format digital printing.', icon: 'Star' },
      ],
    }),
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      heroDescription: 'Best Solution Company je specijalizirana štamparija opremljena modernim digitalnim mašinama kao što su AEON Laser, Gong Zheng, Dizart CNC, MUTOH, SUMA, XEROX, CANON, HP itd.',
      contactCards: [
        ...
        { type: 'hours', title: 'Radno vrijeme', value: 'Aria Mall:Pon-Sub 09:00-22:00 | Ned 10:00-18:00\nSCC:10:00-22:00\nBudakovići:Pon-Pet 08:00-17:00 | Sub 09:00-17:00' },
      ],
      form: {
  ...
  await payload.updateGlobal({
    ...
    data: injectIds(bsContactPage, {
      ...
      heroDescription: 'Best Solution Company is a specialized printing company equipped with modern digital machines such as AEON Laser, Gong Zheng, Dizart CNC, MUTOH, SUMA, XEROX, CANON, HP etc.',
      contactCards: [
        ...
        { type: 'email', title: 'Email', value: 'bscsarajevo@gmail.com' },
        { type: 'hours', title: 'Working hours', value: 'Aria Mall:Mon-Sat 09:00-22:00 | Sun 10:00-18:00\nSCC:10:00-22:00\nBudakovići:Mon-Fri 08:00-17:00 | Sat 09:00-17:00' },
      ],
      form: {
