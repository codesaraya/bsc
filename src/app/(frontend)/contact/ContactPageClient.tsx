...
export default function ContactPageClient({ data }: ContactPageClientProps) {
  ...
  const equipmentList =
    d?.equipment?.length > 0
      ...
      : "AEON Laser, Gong Zheng, Dizart CNC, MUTOH, SUMA, XEROX, CANON, HP";
      ...
      <section className="bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 -mt-[80px] pt-[120px] sm:pt-[160px] pb-12 sm:pb-20 relative overflow-hidden">
        ...
        <Container className="relative z-10 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            {d?.heroDescription ||
              "Best Solution Company je specijalizirana štamparija opremljena modernim digitalnim mašinama kao što su AEON Laser, Gong Zheng, Dizart CNC, MUTOH, SUMA, XEROX, CANON, HP itd."}
          </p>
        </Container>
      </section>
