...
const defaultClients = [
  ...
  { name: "Orbico Beauty", logo: "/Clients/orbico.jpg" },
  ...
  { name: "Petro", logo: "" },
  { name: "Würth", logo: "" },
  { name: "Sarajevski Kiseljak", logo: "" },
  { name: "Intesa Sanpaolo", logo: "" },
  { name: "XYZ", logo: "" },
  { name: "BAT", logo: "" },
  { name: "Pandora", logo: "" },
  { name: "Tom Tailor", logo: "" },
  { name: "Carlsberg BiH", logo: "" },
];
...
export default function ClientsSection({ data }: { data?: any }) {
  ...
  const badge = data?.badge || "Naši klijenti i partneri";
  const title = data?.title || "Saradnje na koje smo ponosni";
  const subtitle = data?.subtitle || "Predstavljamo naše trenutne i dosadašnje klijente i partnere — kompanije s kojima sarađujemo i s kojima smo imali zadovoljstvo sarađivati.";
