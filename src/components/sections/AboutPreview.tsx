...
const defaultFeatures = [
  {
    ...
    description: "UV LED mašina širine štampe 3,2m — jedina na ovim prostorima. Direktan print na krute i fleksibilne materijale vrhunskog kvaliteta.",
  ...
  },
  {
    ...
    description: "Gong Zheng UV štampa na staklo, plexy, alubond, forex, MDF, drvo, Acyplac, Kapafix i još mnogo toga.",
